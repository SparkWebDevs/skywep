define(["require", "exports", './DataEngine', './CurrencyManager'], function (require, exports, __de, __cm) {
    ...
    var GridController = (function () {
        ...
        // --------------------------------------
        GridController.prototype.createGrid = function ($el, colDefinitions, showBorder) {
            var self = this;
            // first clear any content from the given element
            $el.empty();
            // hand over 
            this.$el = $el;
            ...
            $.each([10, 20, 30, 40, 50, 100, 200, 500], function (key, value) {
        ...
        // --------------------------------
        // assign data to the bs-grid
        // --------------------------------
        GridController.prototype.setData = function (data, colDefinitions) {
            var self = this;
            ...
            if (!this.colDefinitions || this.colDefinitions.length == 0)
                throw new Error("BlueSky Grid - missing ColDefinitions!");
        ...
        GridController.prototype.processDataRows = function () {
            var self = this;
        ...
        GridController.prototype.refreshPage = function (action) {
            var self = this;
            // show the loading spinner
            self.$sgloading.css('display', 'flex');
            // disconnect the work from the call to allow the grid to show the loading spinner
        ...
        // --------------------------------
        GridController.prototype.resized = function () {
            var self = this;
        ...
        GridController.prototype.updatePagerButtons = function () {
        ...
        // select the row 
        GridController.prototype.setSelected = function (pkvalue, dblClickOrigin, origin) {
            var self = this;
            // select the pkvalue
            ...
            var $elTarget = this.$datarows.find(".pk-selected");
            $elTarget.removeClass("pk-selected");
            // find the dom row 
            var $elTarget = this.$datarows.find("[data-pkvalue='" + pkvalue + "']");
            $elTarget.addClass("pk-selected");
        ...
        GridController.prototype.attachHandlers = function () {
            var self = this;
            var $grid = this.$grid;
        ...
        // ------------------------------------------------------------------------
        GridController.prototype.getColDefinition = function (colName) {
            return this.colDefinitions.findItem(function (cd) {
                return cd.colName == colName;
            });
        };
        // called when the column order has changed
        GridController.prototype.setOrderChanged = function (colStart, colInsertBefore) {
        ...
        GridController.prototype.getSortSymbol = function (coldef) {
        ...
        GridController.prototype.assignFlexibleColWidth = function () {
        ...
        GridController.prototype.setFlexColumn = function (colName) {
        ...
        GridController.prototype.createHeader = function () {
            var self = this;
        ...
        GridController.prototype.createRows = function () {
            var self = this;
            var s = "";
        ...
        GridController.prototype.createGridStructure = function (showBorder) {
            var s = "";
            // --------------------
        ...
        GridController.prototype.createPager = function () {
            var s = "";
            s += "      <div class='pager'>";
            s += "      <div class='paggerButtonsContainer'>";
